...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                ...
                //optionsBuilder.UseSqlServer("Server=cssql.cegep-heritage.qc.ca;Database=ScriptTestDB24;User id=JBODIKA;Password=password;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>(entity =>
            {
              ...
              new Product
              {
                  ...
                  Image = ImageToByteArray("wwwroot/images/products/charcoal_mask")
              },
    ...
    new Product
    {
        ...
        Image=null
            ...
            modelBuilder.Entity<Order>().HasData(
                new Order() { OrderId = 1, CustomerId = 1, DateCreated = DateTime.Now.AddDays(-10).Date, DateFufilled = DateTime.Now.AddDays(-5).Date, Total = (decimal)86, Taxes = (decimal)12.88 });
           ...
           .WithMany(s => s.CartItem)
           .HasForeignKey(c => c.CartId)  // Rename the foreign key here
           .HasConstraintName("FK_CartItem_ShoppingCart_CartId"); // Set the constraint name
